package com.hy.wmpfdemo.wmpf.contentprovider
...
import com.hy.wmpfdemo.wmpf.MD5Util
import com.hy.wmpfdemo.wmpf.contentprovider.ContentProvideConstants.InvokeChannelConstants
import com.hy.wmpfdemo.wmpf.contentprovider.ContentProvideConstants.SpeakerConstants
...
class ThirdPartContentProvider : ContentProvider() {
    ...
    override fun insert(p0: Uri, p1: ContentValues?): Uri? {
        when (sURIMatcher.match(p0)) {
            ...
            CODE_CALLBACK_INVOKE_CHANNEL -> {
                ...
                DLog.e("invokeId: $invokeId, command: $command, sourceData: $sourceData")
                val cv = ContentValues()

                //接收到来自小程序的数据，发出通知
                BusManager.getBus().post(WmpfEvent(invokeId, command, sourceData))
                ...
                mHandler.postDelayed({
                    ...
                    try {
                        ...
                        DLog.e("callback invoke channel error")
                    }
                }, 1000)
            }
            // 回调事件注册
            CODE_NOTIFY_INVOKE_CHANNEL_EVENT -> {
                ...
                DLog.e("register, eventId: $eventId, event: $event")
    ...
    override fun call(method: String, arg: String?, extras: Bundle?): Bundle? {
        DLog.e("method: $method, arg: $arg, extras: $extras")
        val bundle = Bundle()
    ...
    override fun delete(p0: Uri, p1: String?, p2: Array<String>?): Int {
        if (p2?.size == 2) {
            ...
            DLog.e("unregister success, eventId: $eventId, event: $event")
        }
        return 0
    }
    ...
    private fun notifyEvent(counter: Int, eventId: String?, event: String?) {
        ...
        mHandler.postDelayed({
            ...
            try {
                ...
                DLog.e("send message success, content: event$counter success")
            } catch (e: Exception) {
                DLog.e("callback invoke channel error")
            }
            if (counter < 10) {
    ...
    companion object {
        ...
        //小程序获取手机号成功(与小程序开发者协商，自定义名称)
        const val COMMAND_GET_PHONE_NUMBER_SUCCEED = "getPhoneNumberSucceed"
        //小程序获取手机号失败(与小程序开发者协商，自定义名称)
        const val COMMAND_GET_PHONE_NUMBER_FAILED = "getPhoneNumberFailed"
